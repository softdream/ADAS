...
"""autogenerated by genpy from j2_mono/StructurePerception.msg. Do not edit."""
import codecs
import sys
...
class StructurePerception(genpy.Message):
  _md5sum = "3d9b9bfdc995a7d79a16758bb8437266"
  _type = "j2_mono/StructurePerception"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """Obstacles[] obstacles
Lines[] lines
Image[] parsing
Image[] depth
...
Point[] pts_img
"""
  __slots__ = ['obstacles','lines','parsing','depth','scan_pts']
  _slot_types = ['j2_mono/Obstacles[]','j2_mono/Lines[]','j2_mono/Image[]','j2_mono/Image[]','j2_mono/FreeSpacePoints[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       obstacles,lines,parsing,depth,scan_pts
    ...
    """
    if args or kwds:
      super(StructurePerception, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.parsing)
      buff.write(_struct_I.pack(length))
      for val1 in self.parsing:
        _x = val1
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.depth:
        _x = val1
        buff.write(_get_struct_3iq7i().pack(_x.width, _x.height, _x.channel, _x.time_stamp, _x.send_mode, _x.format, _x.index, _x.count, _x.depth, _x.align, _x.image_counter))
      length = len(self.scan_pts)
      buff.write(_struct_I.pack(length))
      for val1 in self.scan_pts:
