...
"""autogenerated by genpy from j2_mono/Meta.msg. Do not edit."""
import codecs
import sys
...
class Meta(genpy.Message):
  _md5sum = "8c467c3ca79679713158dc0117d10d95"
  _type = "j2_mono/Meta"
...
Point[] pts_img
"""
  __slots__ = ['version','frame_id','data']
  _slot_types = ['int32','int32','j2_mono/Data']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Meta, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4i().pack(_x.version, _x.frame_id, _x.data.version, _x.data.frame_id))
      length = len(self.data.image)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.image:
        _x = val1
      ...
      _x = self
      buff.write(_get_struct_i5fi().pack(_x.data.data_descriptor, _x.data.odometry.x, _x.data.odometry.y, _x.data.odometry.yaw, _x.data.odometry.speed, _x.data.odometry.yaw_rate, _x.data.odometry.time_stamp))
      length = len(self.data.structure_perception.obstacles)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.structure_perception.obstacles:
        _x = val1.cam_id
        ...
        for val2 in val1.obstacle:
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.Struct(pattern).pack(*_v13.sigma_vel))
          _x = _v13
          buff.write(_get_struct_2f().pack(_x.sigma_width, _x.sigma_height))
          length = len(_v13.sigma_position)
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.Struct(pattern).pack(*_v13.sigma_position))
          length = len(val2.property)
          buff.write(_struct_I.pack(length))
          pattern = '<%si'%length
          buff.write(struct.Struct(pattern).pack(*val2.property))
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%si'%length
          buff.write(struct.Struct(pattern).pack(*val2.property_type))
          length = len(val2.property_conf)
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.Struct(pattern).pack(*val2.property_conf))
          length = len(val2.tracking_fmap)
          buff.write(_struct_I.pack(length))
          pattern = '<%sb'%length
          buff.write(struct.Struct(pattern).pack(*val2.tracking_fmap))
        _x = val1.conf_scale
        buff.write(_get_struct_f().pack(_x))
      length = len(self.data.structure_perception.lines)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.structure_perception.lines:
        _x = val1.cam_id
        buff.write(_get_struct_I().pack(_x))
        ...
        for val2 in val1.lines:
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.Struct(pattern).pack(*val2.coeffs))
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.Struct(pattern).pack(*val2.sigma_coeffs))
      length = len(self.data.structure_perception.parsing)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.structure_perception.parsing:
        _x = val1
        buff.write(_get_struct_3iq7i().pack(_x.width, _x.height, _x.channel, _x.time_stamp, _x.send_mode, _x.format, _x.index, _x.count, _x.depth, _x.align, _x.image_counter))
      length = len(self.data.structure_perception.depth)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.structure_perception.depth:
        _x = val1
        buff.write(_get_struct_3iq7i().pack(_x.width, _x.height, _x.channel, _x.time_stamp, _x.send_mode, _x.format, _x.index, _x.count, _x.depth, _x.align, _x.image_counter))
      length = len(self.data.structure_perception.scan_pts)
      buff.write(_struct_I.pack(length))
      for val1 in self.data.structure_perception.scan_pts:
        length = len(val1.property)
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(struct.Struct(pattern).pack(*val1.property))
        _x = val1.cam_id
        buff.write(_get_struct_i().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.frame_id, _x.data.version, _x.data.frame_id,) = _get_struct_4i().unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.data.image.append(val1)
      _x = self
      start = end
      end += 28
      (_x.data.data_descriptor, _x.data.odometry.x, _x.data.odometry.y, _x.data.odometry.yaw, _x.data.odometry.speed, _x.data.odometry.yaw_rate, _x.data.odometry.time_stamp,) = _get_struct_i5fi().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.data.structure_perception.obstacles = []
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          _v29.sigma_vel = s.unpack(str[start:end])
          _x = _v29
          start = end
          end += 8
          ...
          _v29.sigma_position = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%si'%length
          ...
          val2.property = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.property_name = []
          ...
          val2.property_type = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sf'%length
          ...
          val2.property_conf = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sb'%length
          ...
          val2.tracking_fmap = s.unpack(str[start:end])
          val1.obstacle.append(val2)
        start = end
        end += 4
        (val1.conf_scale,) = _get_struct_f().unpack(str[start:end])
        self.data.structure_perception.obstacles.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.data.structure_perception.lines = []
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          val2.coeffs = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val2.end_points = []
          ...
          val2.sigma_coeffs = s.unpack(str[start:end])
          val1.lines.append(val2)
        self.data.structure_perception.lines.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.data.structure_perception.parsing = []
      for i in range(0, length):
        val1 = j2_mono.msg.Image()
        _x = val1
        start = end
        ...
        (_x.width, _x.height, _x.channel, _x.time_stamp, _x.send_mode, _x.format, _x.index, _x.count, _x.depth, _x.align, _x.image_counter,) = _get_struct_3iq7i().unpack(str[start:end])
        self.data.structure_perception.parsing.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.data.structure_perception.depth = []
      for i in range(0, length):
        val1 = j2_mono.msg.Image()
        _x = val1
        start = end
        ...
        (_x.width, _x.height, _x.channel, _x.time_stamp, _x.send_mode, _x.format, _x.index, _x.count, _x.depth, _x.align, _x.image_counter,) = _get_struct_3iq7i().unpack(str[start:end])
        self.data.structure_perception.depth.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.data.structure_perception.scan_pts = []
      for i in range(0, length):
        ...
        val1.property = s.unpack(str[start:end])
        start = end
        end += 4
        (val1.cam_id,) = _get_struct_i().unpack(str[start:end])
        start = end
        ...
        self.data.structure_perception.scan_pts.append(val1)
      return self
